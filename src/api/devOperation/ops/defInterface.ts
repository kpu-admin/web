...
} from './model/defInterfaceModel.ts'
...
export function page(params: PageParams<DefInterfacePageQuery>) {
  return requestClient.post<PageResult<DefInterfaceResultVO>>(`${ServicePrefix}/${MODULAR}/page`, params)
}

export function save(params: DefInterfaceSaveVO) {
  return requestClient.post<DefInterfaceResultVO>(Api.Save.url, params)
}

export function update(params: DefInterfaceUpdateVO) {
  return requestClient.put<DefInterfaceResultVO>(Api.Update.url, params)
}
...
export function query(params?: DefInterfacePageQuery) {
  return requestClient.post<DefInterfaceResultVO[]>(`${ServicePrefix}/${MODULAR}/query`, params)
}

export async function pageRequest(pageQuery: PageParams<DefInterfacePageQuery>): Promise<UserPageRes> {
