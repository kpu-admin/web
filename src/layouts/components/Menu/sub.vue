...
<template>
  <Item
    ref="itemRef" :unique-key="uniqueKey" :item="menu" :level="level" :sub-menu="hasChildren" :expand="opened"
    :always-expand="alwaysOpened" @click="handleClick" @mouseenter="handleMouseenter"
