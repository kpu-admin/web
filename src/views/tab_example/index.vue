...
<template>
  <div>
    <KpuPageHeader title="标签栏" content="功能类似于浏览器的标签栏，支持右键操作" />
    <KpuPageMain title="打开新标签页">
      <p>如果目标地址已在标签栏存在，则直接切换并访问。如果目标地址在标签栏不存在，则会在当前标签页后面插入新的标签页。</p>
      <ElButton @click="open">
        打开主页
      </ElButton>
    </KpuPageMain>
    <KpuPageMain title="关闭当前标签页并跳转">
      <p>关闭当前标签页，同时跳转到新页面。</p>
      <ElButton @click="close">
        关闭当前标签页，并跳转到主页
      </ElButton>
    </KpuPageMain>
    <KpuPageMain title="关闭指定标签页">
